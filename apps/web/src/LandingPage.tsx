  ...
  return (
    ...
    >
      ...
      <main id="main-content">
        ...
        <section className="landing-section use-cases"><span className="section-kicker danger">BEYOND SCHOLARSHIPS</span><h2>A trust pattern for many domains.</h2><div className="pill-grid"><a href="/proof/insurance">Insurance claims · live proof</a><span>Visa applications</span><span>Public benefits</span><span>Financial aid</span><span>Compliance</span><span>Vendor onboarding</span></div></section>
      </main>
